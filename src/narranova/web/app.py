...
class NarranovaWebApp:
    ...
    def _connections(self, environ: dict[str, object], csrf: str) -> str:
        ...
        <section class="saved-connections"><div class="section-heading"><div><h2>Saved connections</h2><p>{len(providers)} configured</p></div></div><div class="connection-list">{cards}</div></section></div>"""
